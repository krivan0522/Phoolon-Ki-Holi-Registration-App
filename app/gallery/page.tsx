...
const galleryData: { [key: string]: { id: number; type: "video" | "image"; src: string; alt: string; }[] } = {
    2023: [
        { id: 1, type: "image", src: "/galleryImage/2024/1.jpg", alt: "Image 1 2022" },
        ...
        { id: 5, type: "image", src: "/galleryImage/2024/2.png", alt: "Image 4 2022" },
        ...
        { id: 12, type: "image", src: "/galleryImage/2022/1.jpg", alt: "Image 1 2024" },
        { id: 13, type: "image", src: "/galleryImage/2022/9.jpg", alt: "Image 2 2024" },
        { id: 14, type: "video", src: "/galleryImage/2024/5.mp4", alt: "Video 2 2022" },
        { id: 15, type: "image", src: "/galleryImage/2024/3.jpg", alt: "Image 2 2024" },
        { id: 16, type: "image", src: "/galleryImage/2024/4.jpg", alt: "Image 2 2024" },
        { id: 17, type: "image", src: "/galleryImage/2024/6.jpg", alt: "Image 2 2024" },
    ],
}
...
export default function Gallery() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-200 to-purple-300 p-10">
            <h1 className="text-4xl font-bold text-center text-indigo-700 mb-8">Previous Years&#39; Highlights</h1>
            <Carousel />
